...
//Get File Resource
function PreviewUploadFile(objectName, objectId, fileType, fileDesc, fieldElementId, callback) {
    ...
    TransferFiles(fieldElementId, objectName, objectId, fileType, fileDesc, callback);
}

function TransferFiles(fieldElementId, objectName, objectId, fileType, fileDesc, callback) {                            
...
function DeleteUploadFile(objectName, fieldElementId, id, callback) {                                                   
...
function DownloadFile(objectName, id) {
    $.fileDownload(
...
function SelectYears() {
    ...
    obj.options[obj.options.length - 31].selected = 1;
}
