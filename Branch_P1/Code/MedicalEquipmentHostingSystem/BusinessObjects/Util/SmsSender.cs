...
namespace BCWS.BusinessObjects.Util
{
    /// <summary>
    /// 单条短信发送
    /// </summary>
    public class SmsSingleSender
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SmsSingleSender"/> class.
        /// </summary>
        /// <param name="sdkappid">The sdkappid.</param>
    ...
    public class SmsMultiSender
    {
        ...
        /// 群发短信设置
        /// </summary>
        /// <param name="sdkappid">appid</param>
    ...
    public class SmsMultiSenderResult
    {
        ...
        public class Detail
        {
            ...
            public override string ToString()
            {
                return string.Format( "\tDetail result {0} errmsg {1} mobile {2} nationcode {3} sid {4} fee {5}", result, errmsg, mobile, nationcode, sid, fee);
            }
        }
