...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../.symlinks/plugins/brother_printer/ios/Lib/BRPtouchPrinterKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/brother_printer/brother_printer.framework"
