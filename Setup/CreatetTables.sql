...
INSERT INTO [lkpSupplierType] VALUES(4,'其它供应商')
GO
...
INSERT INTO [lkpContractScope] VALUES(3,'其它')
GO
...
INSERT INTO [lkpDepartmentType] VALUES(9,'其它科室')
GO
...
GO
INSERT INTO [lkpDepartment] VALUES('其它','qt',99999,9)
...
INSERT INTO [lkpRequestType] VALUES(14,'其它服务')
GO
...
CREATE TABLE [dbo].[tblEquipment](
	...
	[FujiClass2ID] [int] NULL,					-- 富士II类id
	[CTSerialCode] [nvarchar](30) NULL,			-- CT序列号
	[CTUsedSeconds] [decimal](12,2) NULL,			-- CT已使用秒次
...
CREATE TABLE [dbo].[tblAuditHdr](
	...
	[Operation] [int] NOT NULL,					-- 操作类型:1新增,2编辑
...
CREATE TABLE [dbo].[tblContract](
	...
	[ScopeComments] nvarchar(50) NULL,			-- 其它范围备注
...
-- 服务合同零件关联表
CREATE TABLE [dbo].[jctContractComponent](
	[ContractID] [int] NOT NULL,
	[EquipmentID] [int] NOT NULL,
	[ComponentID] [int] NOT NULL,
	CONSTRAINT PK_jctContractComponent PRIMARY KEY ([ContractID],[EquipmentID],[ComponentID]),
)
GO

-- 服务合同耗材关联表
CREATE TABLE [dbo].[jctContractConsumable](
	[ContractID] [int] NOT NULL,
	[EquipmentID] [int] NOT NULL,
	[ConsumableID] [int] NOT NULL,
	CONSTRAINT PK_jctContractConsumable PRIMARY KEY ([ContractID],[EquipmentID],[ConsumableID]),
)
GO
...
INSERT INTO [lkpCustRptTemplateField] VALUES(1,48 ,'tblEquipment','EquipmentFujiClass2Name','设备富士II类名称')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,49 ,'tblEquipment','CTSerialCode','CT球管序列号')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,50 ,'tblEquipment','CTUsedSeconds','CT球管已使用秒次')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,51 ,'tblManufacturer','ManufacturerName','厂商名称')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,52 ,'tblManufacturer','ManufacturerProvince','厂商省份')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,53 ,'tblManufacturer','ManufacturerMobile','厂商电话')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,54 ,'tblManufacturer','ManufacturerAddress','厂商地址')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,55 ,'tblManufacturer','ManufacturerContact','厂商联系人')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,56 ,'tblManufacturer','ManufacturerContactMobile','厂商联系电话')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,57 ,'tblSupplier','DealerName','经销商名称')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,58 ,'tblSupplier','DealerProvince','经销商省份')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,59 ,'tblSupplier','DealerMobile','经销商电话')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,60 ,'tblSupplier','DealerAddress','经销商地址')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,61 ,'tblSupplier','DealerContact','经销商联系人')
INSERT INTO [lkpCustRptTemplateField] VALUES(1,62 ,'tblSupplier','DealerContactMobile','经销商联系电话')
...
INSERT INTO [lkpCustRptTemplateField] VALUES(2,5 ,'tblContract','ScopeComments','合同其它范围备注')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,6 ,'tblContract','Amount','合同金额')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,7 ,'tblContract','ProjectNum','合同项目编号')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,8 ,'tblContract','ContractStartDate','合同开始日期')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,9 ,'tblContract','ContractEndDate','合同结束日期')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,10,'tblContract','ContractComments','合同备注')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,11,'tblEquipment','EquipmentID','设备系统编号')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,12,'tblEquipment','EquipmentName','设备名称')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,13,'tblEquipment','EquipmentCode','设备型号')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,14,'tblEquipment','SerialCode','设备序列号')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,15,'tblEquipment','EquipmentLevelDesc','等级')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,16,'tblEquipment','EquipmentClass1Name','设备分类一级')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,17,'tblEquipment','EquipmentClass2Name','设备分类二级')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,18,'tblEquipment','EquipmentClass3Name','设备分类三级')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,19,'tblEquipment','ServiceScopeDesc','整包范围')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,20,'tblEquipment','EquipmentManufacturerName','设备厂商')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,21,'tblEquipment','DepartmentName','使用科室')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,22,'tblEquipment','InstalSite','安装地点')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,23,'tblSupplier','SupplierName','供应商名称')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,24,'tblSupplier','SupplierProvince','供应商省份')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,25,'tblSupplier','SupplierMobile','供应商电话')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,26,'tblSupplier','SupplierAddress','供应商地址')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,27,'tblSupplier','SupplierContact','供应商联系人')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,28,'tblSupplier','SupplierContactMobile','供应商联系电话')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,29,'tblSupplier','SupplierType','供应商类型')
INSERT INTO [lkpCustRptTemplateField] VALUES(2,30,'tblSupplier','SupplierStatus','供应商经营状态')
...
INSERT INTO [lkpCustRptTemplateField] VALUES(99,1 ,'tblFujiClass2','FujiClass2FujiClass1','富士I类')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,2 ,'tblFujiClass2','FujiClass2Equipment1','设备I类')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,3 ,'tblFujiClass2','FujiClass2Equipment2','设备II类')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,4 ,'tblFujiClass2','FujiClass2Name','简称')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,5 ,'tblFujiClass2','FujiClass2Description','描述')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,6 ,'tblFujiClass2','FujiClass2IncludeLabour','是否包含人工费')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,7 ,'tblFujiClass2','FujiClass2PatrolTimes','巡检次数')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,8 ,'tblFujiClass2','FujiClass2PatrolHours','巡检工时	')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,9 ,'tblFujiClass2','FujiClass2MaintenanceTimes','保养次数')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,10,'tblFujiClass2','FujiClass2MaintenanceHours','保养工时')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,11 ,'tblFujiClass2','FujiClass2RepairHours','维修平均工时')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,12 ,'tblFujiClass2','FujiClass2IncludeContract','是否包含维保服务费')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,13 ,'tblFujiClass2','FujiClass2FullCoveragePtg','全保单价占设备金额百分比')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,14 ,'tblFujiClass2','FujiClass2TechCoveragePtg','技术保单价占设备金额百分比')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,15 ,'tblFujiClass2','FujiClass2IncludeSpare','是否包含备用机成本')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,16 ,'tblFujiClass2','FujiClass2SparePrice','备用机标准单价')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,17 ,'tblFujiClass2','FujiClass2SpareRentPtg','月租占标准单价比率')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,18 ,'tblFujiClass2','FujiClass2IncludeRepair','是否包含维保额外维修费')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,19 ,'tblFujiClass2','FujiClass2Usage','使用量')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,20 ,'tblFujiClass2','FujiClass2EquipmentType','设备等级')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,21 ,'tblFujiClass2','FujiClass2RepairComponentCost','单次维修平均零件成本')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,22 ,'tblFujiClass2','FujiClass2Repair3partyRatio','工程师无法修复概率')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,23 ,'tblFujiClass2','FujiClass2Repair3partyCost','购维修服务平均成本	')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,24 ,'tblFujiClass2','FujiClass2RepairCostRatio','故障成本占设备金额比例')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,25 ,'tblFujiClass2','FujiClass2MethodID','故障率计算方式')  
                                             
INSERT INTO [lkpCustRptTemplateField] VALUES(99,101 ,'tblComponent','ComponentFujiClass2','零件富士II类')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,102 ,'tblComponent','ComponentName','零件名称')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,103 ,'tblComponent','ComponentDescription','零件描述')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,104 ,'tblComponent','ComponentType','零件类型')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,105 ,'tblComponent','CompomemtStdPrice','零件标准单价')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,106 ,'tblComponent','ComponentUsage','零件标准使用量(CT日使用量)')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,107 ,'tblComponent','ComponentTotalSeconds','零件CT球管理论寿命')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,108 ,'tblComponent','ComponentSecondsPer','零件CT球管秒次/人')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,109 ,'tblComponent','ComponentIsIncluded','零件是否参与估值')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,110 ,'tblComponent','ComponentIncludeContract','零件是否维保')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,111 ,'tblComponent','ComponentMethodID','零件故障率计算方式')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,112 ,'tblComponent','ComponentIsActive','零件状态')  
                                             
INSERT INTO [lkpCustRptTemplateField] VALUES(99,201 ,'tblConsumable','ConsumableFujiClass2','耗材富士II类')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,202 ,'tblConsumable','ConsumableName','耗材名称名称')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,203 ,'tblConsumable','ConsumableDescription','耗材描述描述')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,204 ,'tblConsumable','ConsumableType','耗材类型')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,205 ,'tblConsumable','ConsumableStdPrice','耗材标准单价')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,206 ,'tblConsumable','ConsumableReplaceTimes','耗材更换频率')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,207 ,'tblConsumable','ConsumableCostPer','单次保养耗材成本')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,208 ,'tblConsumable','ConsumableIsIncluded','耗材是否参与估值')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,209 ,'tblConsumable','ConsumableIncludeContract','是否维保')
INSERT INTO [lkpCustRptTemplateField] VALUES(99,210 ,'tblConsumable','ConsumableIsActive','状态') 
GO
DECLARE @i INT
DECLARE @j INT  
DECLARE @idx INT 
...
BEGIN 
	...
	WHILE @j<12
	BEGIN
		INSERT INTO [lkpCustRptTemplateField] VALUES(99,@idx+1,'tblFaultRate','FaultRateRate-'+CONVERT(VARCHAR(2),@i+1)+'-'+CONVERT(VARCHAR(2),@j+1),'故障率第'+CONVERT(VARCHAR(2),@i+1)+'年第'+CONVERT(VARCHAR(2),@j+1)+'月')
		SET @j=@j+1
		SET @idx = @idx +1
	END
	SET @i = @i+1
