...
class HttpRequest {
  ...
  // default server
  static const String API_PREFIX = 'http://fujifilm.esdpro.com/atoi_P1';
  //static const String API_PREFIX = 'http://139.196.238.244/Atoi_Demo';
  //static const String API_PREFIX = 'http://139.196.238.244/hyxrmyy';
  //static const String API_PREFIX = 'http://139.196.238.244/AtoiDemo';
  //static const String API_PREFIX = 'http://139.196.238.244/AtoiTest';
